...
<div class="container">
    ...
    <!-- <div class="accordion " id="prescriptionAccordion">
        ...
        <div class="card">
            ...
            <div id="collapseFour" class="collapse" aria-labelledby="headingFour" data-target="#collapseFour">
                <div class="card-body">
                    <div class="form-row">
                        <div class="form-group col-md-5">
                            <label for="medicationNameRow1" id="medicationLable">Лекарствен продукт*</label>
        ...
        <div class="card">
            ...
            <div id="collapseFive" class="collapse" aria-labelledby="headingFive" data-target="#collapseFive">
                <div class="card-body">
                    <div class="form-row">
                        <div class="form-group col-md-5">
                            <label for="medicationNameRow1" id="medicationLable">Лекарствен продукт*</label>
        ...
        <div class="card ">
            ...
            <div id="collapseSix" class="collapse" aria-labelledby="headingSix" data-target="#collapseSix">
                <div class="card-body">
                    <div class="form-row">
                        <div class="form-group col-md-5">
                            <label for="medicationNameRow1" id="medicationLable">Лекарствен продукт*</label>
    ...
    <!-- тук приключват данните за 6ти медикамент -->
